...
export const metadata: Metadata = {
  ...
  description: 'Discover Moddio, an open-source, no-code game engine that empowers creators to build and deploy multiplayer games.',
  alternates: {
    canonical: '/moddio',
  },
};
          ...
          <div className="container mx-auto px-4">
            <div className="mb-16 text-center">
              ...
              <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
                Explore Moddio's powerful no-code game engine
              </p>
            </div>
