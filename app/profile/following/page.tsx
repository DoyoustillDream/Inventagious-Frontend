          ...
          <div className="bg-white border-4 border-black rounded-lg p-6 md:p-8 shadow-lg">
            ...
            {following.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-lg font-bold text-gray-800 mb-4">Not following anyone yet</p>
                <p className="text-gray-600 mb-6">
                  Start following people to see their updates and projects here.
                </p>
                <Link
                  href="/profile"
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-gray-500 mt-1">
                            Following since {new Date(user.followedAt).toLocaleDateString('en-US', {
                              year: 'numeric',
                              month: 'long',
                              day: 'numeric',
                            })}
