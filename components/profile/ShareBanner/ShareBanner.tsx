...
export default function ShareBanner({
  ...
  return (
    <button
      onClick={handleShare}
      disabled={isSharing}
      className="hand-drawn rounded-lg border-4 border-black bg-white hover:bg-yellow-200 px-4 py-2 sm:px-6 sm:py-3 text-sm sm:text-base font-bold text-black transition hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 w-full sm:w-auto"
    >
      {isSharing ? (
        <>
