      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl font-semibold text-gray-800 leading-relaxed mb-4">
            Your donations are protected. We guarantee you a full refund for up to a year in the rare case that fraud occurs.
          </p>
          <p className="text-lg font-semibold text-gray-700 max-w-3xl mx-auto">
            Built on Solana's blockchain with Program Derived Addresses (PDAs) for escrow, transaction signature verification, admin approval systems, and comprehensive audit logging. Every contribution is protected by our multi-layered Trust & Safety measures.
          </p>
        </div>
      </div>
    </section>
